...
if __name__ == '__main__':
    ...
    experiment1 = ClassifierExperiment({
        ...
        'asset_opts': {
            'save_assets': True,
            'dir': './classifier_experiment/generated_assets/fashion_mnist/'
        },
    ...
    experiment2 = ClassifierExperiment({
        ...
        'asset_opts': {
            'save_assets': True,
            'dir': './classifier_experiment/generated_assets/mnist/'
        },
        'dataset': tf.keras.datasets.mnist,
        'custom_image_dir': './classifier_experiment/custom images/mnist/*.png',
        'labels': [0, 0, 1, 9, 8],
        'class_names': [
            '0',  # 0
            '1',  # 1
